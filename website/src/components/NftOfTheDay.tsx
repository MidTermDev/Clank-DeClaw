        ...
        <div className="w-20 h-20 rounded-lg overflow-hidden border-2 border-amber-200 group-hover:border-amber-400 transition-colors">
          <img
            ...
            onError={(e) => {
              ...
              target.onerror = null;
              target.src = `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512"><rect fill="%23fef3c7" width="512" height="512"/><text x="256" y="256" text-anchor="middle" dominant-baseline="middle" font-family="monospace" font-size="48" fill="%2392400e">%23${nft.id}</text></svg>`;
            }}
          />
        </div>
        <div>
